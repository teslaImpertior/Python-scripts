...
userInput = input()#'account' #input()

# - load csv ====================================================================================================================================================================================
file_exists = os.path.isfile('seek_data.csv') ################ for testing purposes (use "Account")
...
if file_exists == 0:
    ...
    try:
        CSV_buffer = pd.read_csv('seek_data.csv', sep=',', header='infer')# read CSV file into buffer ################ for testing purposes (use "Account")
